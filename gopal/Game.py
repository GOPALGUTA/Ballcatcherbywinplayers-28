...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
GREEN = (0, 255, 0)  # New color for falling items
BLUE = (0, 0, 255)  # New color for basket
...
while True:
    ...
    if not game_over:
        ...
        display_score()
        pygame.draw.rect(screen, BLUE, basket)  # Draw the basket in blue

        # Draw falling items as circles (balls)
        for item in falling_items:
            pygame.draw.circle(screen, GREEN, item.center, ITEM_RADIUS)  # Draw falling items in green
